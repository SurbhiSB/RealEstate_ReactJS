...
const handleSubmit = async (e) => {
  ...
  try {
    const res = await axios.post("http://localhost:3000/api/purchase-bills", payload);
    if (res.data.success) {
      alert("✅ Purchase Bill Submitted Successfully!");
    ...
    alert("Failed to submit Purchase Bill");
  }
};
  ...
  <div>
    ...
    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div>
                <label className="text-sm font-medium text-gray-700 block mb-1">Bill File Title</label>
                <input type="text" className="w-full border border-gray-300 rounded-lg px-3 py-2 mb-2" />
                <label className="text-sm font-medium text-gray-700 block mb-1">Bill File</label>
