...
export default function SiteFeesReport() {
...
useEffect(() => {
  ...
  useEffect(() => {
    axios.get('http://localhost:3000/api/SiteFeesExpenses/SiteFeesExpenses')
      .then(res => {
        if (res.data.success) {
  ...
  return (
    <div className="flex">
          ...
          <div className="flex-1">
            <Header />
    <div className="p-4">
      <h2 className="text-lg font-semibold mb-4">Sitefees Expenses Report</h2>
