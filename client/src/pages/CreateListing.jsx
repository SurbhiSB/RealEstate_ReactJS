 ...
 <div className='flex items-center gap-2'>
        ...
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex gap-4'>
                ...
                <button className='p-3 text-green-700 border border-green-700 rounded-lg uppercase hover:bg-green-700 hover:text-white disabled:opacity-80'>Upload</button>
            </div>
